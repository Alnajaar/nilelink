// scripts/deploy-modular-ecosystem.js
// Modular deployment to avoid contract size limits
...
async function main() {
    console.log('🚀 MODULAR NILELINK ECOSYSTEM DEPLOYMENT');
    console.log('========================================\n');
    ...
    try {
        // PHASE 1: DEPLOY CORE COMPONENTS SEPARATELY
        ...
        const swarmIntelligence = await SwarmIntelligence.deploy(ethers.ZeroAddress);
        await swarmIntelligence.waitForDeployment();
        const swarmAddress = await swarmIntelligence.getAddress();
        deploymentInfo.contracts.swarmIntelligence = swarmAddress;
        console.log('✅ SwarmIntelligence deployed to:', swarmAddress);
        ...
        const coreAIOracle = await CoreAIOracle.deploy(securityOrchestratorAddress);
        ...
        await securityOrchestrator.setAIOracle(coreAIOracleAddress);
        ...
        const deploymentPath = path.join(__dirname, '..', `deployment-${network.name}-modular.json`);
        ...
        // FINAL SUMMARY
        console.log('\n🎉 MODULAR ECOSYSTEM DEPLOYMENT SUCCESSFUL!');
        console.log('===========================================');
