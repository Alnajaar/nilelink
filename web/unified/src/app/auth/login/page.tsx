...
import { Eye, EyeOff, Mail, Smartphone, Shield, AlertCircle, CheckCircle, Loader2, ArrowLeft } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-100">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">Sign in to your NileLink account</p>
                </div>
                            ...
                            <form onSubmit={handleVerifyOTP} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-center text-lg font-mono tracking-widest"
                                        placeholder="000000"
                                        maxLength={6}
                                    />
                                </div>
