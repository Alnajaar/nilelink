...
const APPS = [
    ...
    { name: 'POS System', url: URLS.pos, description: 'Merchant Terminal' },
    { name: 'Delivery', url: URLS.delivery, description: 'Driver Network' },
    { name: 'Customer', url: URLS.customer, description: 'Marketplace' },
    { name: 'Supplier', url: URLS.supplier, description: 'Supply Chain' },
    { name: 'Investor', url: URLS.dashboard, description: 'Protocol Dashboard' },
];
