                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-primary-dark/70">
                            <li><a href="https://pos.nilelink.app" className="hover:text-primary-dark transition-colors">POS System</a></li>
                            <li><a href="https://delivery.nilelink.app" className="hover:text-primary-dark transition-colors">Delivery Network</a></li>
                            <li><a href="https://customer.nilelink.app" className="hover:text-primary-dark transition-colors">Marketplace</a></li>
                            <li><a href="https://supplier.nilelink.app" className="hover:text-primary-dark transition-colors">Supplier Hub</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="font-semibold text-primary-dark mb-4">Protocol</h3>
                        <ul className="space-y-2 text-sm text-primary-dark/70">
                            <li><a href="https://dashboard.nilelink.app" className="hover:text-primary-dark transition-colors">Investor Dashboard</a></li>
                            <li><a href="https://nilelink.app/governance" className="hover:text-primary-dark transition-colors">Governance</a></li>
                            <li><a href="https://nilelink.app/tokenomics" className="hover:text-primary-dark transition-colors">Tokenomics</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="font-semibold text-primary-dark mb-4">Resources</h3>
                        <ul className="space-y-2 text-sm text-primary-dark/70">
                            <li><a href="https://docs.nilelink.app" className="hover:text-primary-dark transition-colors">Documentation</a></li>
                            <li><a href="https://status.nilelink.app" className="hover:text-primary-dark transition-colors">System Status</a></li>
