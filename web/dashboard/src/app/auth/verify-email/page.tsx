        ...
        <div className="min-h-screen bg-gradient-to-br from-primary to-secondary flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
                ...
                <div className="mt-6 text-center text-sm text-gray-600">
                    <p>Didn't receive the email? <a href="/auth/resend-verification" className="text-secondary hover:underline font-semibold">Resend</a></p>
                </div>
            </div>
        </div>
    );
...
export default function VerifyEmailPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-primary to-secondary flex items-center justify-center"><p>Loading...</p></div>}>
            <VerifyEmailContent />
        </Suspense>
    );
}
